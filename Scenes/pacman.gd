...
func get_input():
	...
	if Input.is_action_pressed("left") or Input.is_action_just_pressed("left_joy"):
		next_movement_direction = Vector2.LEFT
		rotation_degrees = 0
	elif  Input.is_action_pressed("right") or Input.is_action_just_pressed("right_joy"):
		next_movement_direction = Vector2.RIGHT
		rotation_degrees = 180
	elif Input.is_action_pressed("down") or Input.is_action_pressed("down_joy"):
		next_movement_direction = Vector2.DOWN
		rotation_degrees = 270
	elif Input.is_action_pressed("up") or Input.is_action_pressed("up_joy"):
